...
Catapult::Catapult(int position) : Unit::Unit(stats["CaveAge"]["Catapult"].price, stats["CaveAge"]["Catapult"].hp, stats["CaveAge"]["Catapult"].atk, position, std::make_pair(stats["CaveAge"]["Catapult"].range_1, stats["CaveAge"]["Catapult"].range_2)) {}

std::map<int, std::map<bool, std::string> > Catapult::m_normalSkin = {};
std::map<int, std::map<bool, std::string> > Catapult::m_attackSkin = {};

std::string Catapult::skin(int h, bool owner) {
...
void Catapult::attack(Unit* u) {
  u->takeDamage(m_atk);
}

int Catapult::action1(std::vector<std::pair<Unit*, bool>> targets, bool enemyBaseReachable) {
...
void Catapult::action2(int newPosition) {  // Catapult has no action2
...
*/
int Catapult::action3(std::tuple<Unit*, int, bool> target, bool enemyBaseReachable) {
...
void Catapult::initSkin() {
  std::ifstream file("config/skins/cave/catapultSkins.txt");
